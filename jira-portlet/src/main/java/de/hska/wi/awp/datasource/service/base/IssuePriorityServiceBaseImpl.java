...
import de.hska.wi.awp.datasource.service.IssuePriorityService;
...
/**
 * Provides the base implementation for the issue priority remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.service.impl.IssuePriorityServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class IssuePriorityServiceBaseImpl extends BaseServiceImpl
    implements IssuePriorityService, IdentifiableBean {
    ...
    private IssuePriorityServiceClpInvoker _clpInvoker = new IssuePriorityServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.service.IssuePriorityServiceUtil} to access the issue priority remote service.
     */
