...
import de.hska.wi.awp.datasource.service.StatusService;
...
/**
 * Provides the base implementation for the status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.service.impl.StatusServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class StatusServiceBaseImpl extends BaseServiceImpl
    implements StatusService, IdentifiableBean {
    ...
    private StatusServiceClpInvoker _clpInvoker = new StatusServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.service.StatusServiceUtil} to access the status remote service.
     */
