...
/**
 * Provides the local service utility for JiraUser. This utility wraps
 * {@link de.hska.wi.awp.datasource.service.impl.JiraUserLocalServiceImpl} and is the
 ...
 * @generated
 */
public class JiraUserLocalServiceUtil {
    private static JiraUserLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link de.hska.wi.awp.datasource.service.impl.JiraUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static de.hska.wi.awp.datasource.model.JiraUser addJiraUser(
        de.hska.wi.awp.datasource.model.JiraUser jiraUser)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addJiraUser(jiraUser);
    }
    ...
    */
    public static de.hska.wi.awp.datasource.model.JiraUser createJiraUser(
        de.hska.wi.awp.datasource.service.persistence.JiraUserPK jiraUserPK) {
        return getService().createJiraUser(jiraUserPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.model.JiraUser deleteJiraUser(
        de.hska.wi.awp.datasource.service.persistence.JiraUserPK jiraUserPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteJiraUser(jiraUserPK);
    }
    ...
    */
    public static de.hska.wi.awp.datasource.model.JiraUser deleteJiraUser(
        de.hska.wi.awp.datasource.model.JiraUser jiraUser)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteJiraUser(jiraUser);
    }
    ...
    */
    ...
    public static de.hska.wi.awp.datasource.model.JiraUser fetchJiraUser(
        de.hska.wi.awp.datasource.service.persistence.JiraUserPK jiraUserPK)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchJiraUser(jiraUserPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.model.JiraUser getJiraUser(
        de.hska.wi.awp.datasource.service.persistence.JiraUserPK jiraUserPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getJiraUser(jiraUserPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<de.hska.wi.awp.datasource.model.JiraUser> getJiraUsers(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getJiraUsers(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getJiraUsersCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getJiraUsersCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.model.JiraUser updateJiraUser(
        de.hska.wi.awp.datasource.model.JiraUser jiraUser)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateJiraUser(jiraUser);
    }
    ...
    */
    ...
    public static java.lang.String getProjectNameForUserId(
        java.lang.String userId) {
        return getService().getProjectNameForUserId(userId);
    }
    ...
    public static JiraUserLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    JiraUserLocalService.class.getName());

            if (invokableLocalService instanceof JiraUserLocalService) {
                _service = (JiraUserLocalService) invokableLocalService;
            } else {
                _service = new JiraUserLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(JiraUserLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(JiraUserLocalService service) {
    }
}
