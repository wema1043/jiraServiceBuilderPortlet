...
public class ProjectLocalServiceClpInvoker {
    ...
    public ProjectLocalServiceClpInvoker() {
        ...
        _methodName76 = "getProjectIdForProjectName";

        _methodParameterTypes76 = new String[] { "java.lang.String" };

        _methodName77 = "getAllProjects";

        _methodParameterTypes77 = new String[] {  };

        _methodName78 = "ParseJsonToProjects";

        _methodParameterTypes78 = new String[] { "java.lang.String" };

        _methodName79 = "deleteAllProjects";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return ProjectLocalServiceUtil.addProject((de.hska.wi.awp.datasource.model.Project) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return ProjectLocalServiceUtil.createProject((java.lang.String) arguments[0]);
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return ProjectLocalServiceUtil.deleteProject((java.lang.String) arguments[0]);
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return ProjectLocalServiceUtil.deleteProject((de.hska.wi.awp.datasource.model.Project) arguments[0]);
        }
        ...
        if (_methodName10.equals(name) &&
            ...
            return ProjectLocalServiceUtil.fetchProject((java.lang.String) arguments[0]);
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return ProjectLocalServiceUtil.getProject((java.lang.String) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return ProjectLocalServiceUtil.updateProject((de.hska.wi.awp.datasource.model.Project) arguments[0]);
        }
        ...
        if (_methodName76.equals(name) &&
            ...
            return ProjectLocalServiceUtil.getProjectIdForProjectName((java.lang.String) arguments[0]);
        }

        if (_methodName77.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes77, parameterTypes)) {
            return ProjectLocalServiceUtil.getAllProjects();
        }

        if (_methodName78.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes78, parameterTypes)) {
            ProjectLocalServiceUtil.ParseJsonToProjects((java.lang.String) arguments[0]);
        ...
        if (_methodName79.equals(name) &&
            ...
            ProjectLocalServiceUtil.deleteAllProjects();
        ...
        if (_methodName80.equals(name) &&
            ...
            return ProjectLocalServiceUtil.loadConfigFile();
        }
