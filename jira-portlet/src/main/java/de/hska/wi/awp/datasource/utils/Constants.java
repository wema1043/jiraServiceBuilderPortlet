...
public class Constants {
	...
	public static final String JIRA_API_ALL_MEMBERS_FOR_PROJECT = 	"/rest/api/2/user/assignable/search?project=";
	public static final String JIRA_API_ALL_PROJECTS = 	"/rest/api/2/project";
