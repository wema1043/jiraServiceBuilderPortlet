...
public class IssueLocalServiceClp implements IssueLocalService {
    ...
    public IssueLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getAllIssues";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "ParseJsonToIssue";

        _methodParameterTypes20 = new String[] { "java.lang.String" };

        _methodName21 = "deleteAllIssues";
    ...
    public de.hska.wi.awp.datasource.model.Issue addIssue(
        ...
        return (de.hska.wi.awp.datasource.model.Issue) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.model.Issue> getIssues(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.model.Issue>) ClpSerializer.translateOutput(returnObj);
    }
