...
public class ProjectLocalServiceClp implements ProjectLocalService {
    ...
    public ProjectLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getProjectIdForProjectName";

        _methodParameterTypes19 = new String[] { "java.lang.String" };

        _methodName20 = "getAllProjects";

        _methodParameterTypes20 = new String[] {  };

        _methodName21 = "ParseJsonToProjects";

        _methodParameterTypes21 = new String[] { "java.lang.String" };

        _methodName22 = "deleteAllProjects";
    ...
    public de.hska.wi.awp.datasource.model.Project addProject(
        ...
        return (de.hska.wi.awp.datasource.model.Project) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.model.Project> getProjects(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.model.Project>) ClpSerializer.translateOutput(returnObj);
    }
