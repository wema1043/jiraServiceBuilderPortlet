...
import de.hska.wi.awp.datasource.service.IssueTypeService;
...
/**
 * Provides the base implementation for the issue type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.service.impl.IssueTypeServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class IssueTypeServiceBaseImpl extends BaseServiceImpl
    implements IssueTypeService, IdentifiableBean {
    ...
    private IssueTypeServiceClpInvoker _clpInvoker = new IssueTypeServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.service.IssueTypeServiceUtil} to access the issue type remote service.
     */
