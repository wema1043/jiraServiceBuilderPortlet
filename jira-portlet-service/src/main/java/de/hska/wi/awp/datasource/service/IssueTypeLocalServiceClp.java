 ...
 * @generated
 */
public class IssueTypeLocalServiceClp implements IssueTypeLocalService {
    ...
    public IssueTypeLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public de.hska.wi.awp.datasource.model.IssueType addIssueType(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(issueType) });
        } catch (Throwable t) {
        ...
        return (de.hska.wi.awp.datasource.model.IssueType) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.model.IssueType> getIssueTypes(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.model.IssueType>) ClpSerializer.translateOutput(returnObj);
    }
